...
public class Client {
    public static void main(String[] args) {
        ...
        csvRows.forEach(e -> all.add(new EmployeeCSVAdapter(e)));
        dbRows.forEach(e -> all.add(new EmployeeDBAdapter(e)));
        ldapRows.forEach(e -> all.add(new EmployeeLDAPAdapter(e)));
